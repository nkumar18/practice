...
public class TestCustomerService {
	...
	public static void main(String[] args) throws Exception {
		...
		String httpGetURL = "http://localhost:9999/RestEasy-Spring-Hibernate/resteasy/customerservice/getcustomer/5";
		...
		String httpPostURL = "http://localhost:9999/RestEasy-Spring-Hibernate/resteasy/customerservice/addcustomer";
